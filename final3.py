...
# Tab 1: Every Major
with st.container():
    st.title("Every Major")
    st.write("Distribution of mental illness for all majors.")
...
with st.container():
    st.title("No Mental Illness")
    st.write("Distribution of mental illness for majors with at least one mental illness.")
